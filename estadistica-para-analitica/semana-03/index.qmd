...
[Abrir la presentación de la sesión](presentacion-calculo-manual.html){.btn .btn-primary
role="button"}
...
::: {.diagrama}
![](imagenes/media-vs-mediana.svg){fig-alt="Línea de población por estado en millones de habitantes, con California marcada aparte como un punto alejado del resto. La mediana cae dentro del grupo denso de estados; la media queda desplazada hacia la derecha, más cerca de California."}
:::
...
::: {.diagrama}
![](imagenes/histograma-poblacion.svg){fig-alt="Histograma de la población por estado en 10 contenedores de igual ancho, con la mayoría de los estados concentrados en los primeros dos contenedores y una cola larga hacia la derecha con pocos estados muy poblados."}
:::
...
::: {.diagrama}
![](imagenes/histograma-ingresos.svg){fig-alt="Histograma del ingreso anual de 50000 solicitantes de crédito en 10 contenedores, concentrado entre 43000 y 82000 dólares, con una cola larga hacia la derecha hasta cerca de 200000 dólares."}
:::
...
## Actividad de la semana: calidad de un vino

Vas a aplicar las herramientas de esta guía (tabla de frecuencias, histograma, y medidas de
localización y dispersión) sobre datos reales de control de calidad de un vino, con el mismo método
que usaste sobre `state.csv`.

[Abrir los datos y el código de carga](datos-calidad-vino.html){.btn .btn-primary role="button"}
